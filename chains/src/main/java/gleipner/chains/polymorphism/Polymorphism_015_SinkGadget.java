...
public class Polymorphism_015_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_015_SinkGadget () {
    }

    public Polymorphism_015_SinkGadget (String tainted, SinkGadget sinkGadget) {
