...
public class Polymorphism_016_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_016_SinkGadget () {
    }

    public Polymorphism_016_SinkGadget (String tainted, SinkGadget sinkGadget) {
