...
public class Polymorphism_017_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_017_SinkGadget () {
    }

    public Polymorphism_017_SinkGadget (String tainted, SinkGadget sinkGadget) {
