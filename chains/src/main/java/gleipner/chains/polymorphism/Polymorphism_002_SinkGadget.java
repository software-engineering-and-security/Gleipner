...
public class Polymorphism_002_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_002_SinkGadget () {
    }

    public Polymorphism_002_SinkGadget (String tainted, SinkGadget sinkGadget) {
