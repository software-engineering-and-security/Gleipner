...
public class Polymorphism_008_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_008_SinkGadget () {
    }

    public Polymorphism_008_SinkGadget (String tainted, SinkGadget sinkGadget) {
