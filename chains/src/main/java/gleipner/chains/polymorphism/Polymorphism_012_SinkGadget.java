...
public class Polymorphism_012_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_012_SinkGadget () {
    }

    public Polymorphism_012_SinkGadget (String tainted, SinkGadget sinkGadget) {
