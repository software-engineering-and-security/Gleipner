...
public class Polymorphism_007_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_007_SinkGadget () {
    }

    public Polymorphism_007_SinkGadget (String tainted, SinkGadget sinkGadget) {
