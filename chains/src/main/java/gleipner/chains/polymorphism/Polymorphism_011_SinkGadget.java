...
public class Polymorphism_011_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_011_SinkGadget () {
    }

    public Polymorphism_011_SinkGadget (String tainted, SinkGadget sinkGadget) {
