...
public class Polymorphism_001_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_001_SinkGadget () {
    }

    public Polymorphism_001_SinkGadget (String tainted, SinkGadget sinkGadget) {
