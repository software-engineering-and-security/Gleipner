...
public class Polymorphism_013_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_013_SinkGadget () {
    }

    public Polymorphism_013_SinkGadget (String tainted, SinkGadget sinkGadget) {
