...
public class Polymorphism_004_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_004_SinkGadget () {
    }

    public Polymorphism_004_SinkGadget (String tainted, SinkGadget sinkGadget) {
