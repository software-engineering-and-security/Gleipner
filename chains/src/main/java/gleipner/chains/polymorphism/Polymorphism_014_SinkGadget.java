...
public class Polymorphism_014_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_014_SinkGadget () {
    }

    public Polymorphism_014_SinkGadget (String tainted, SinkGadget sinkGadget) {
