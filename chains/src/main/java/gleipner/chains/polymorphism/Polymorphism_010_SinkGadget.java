...
public class Polymorphism_010_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_010_SinkGadget () {
    }

    public Polymorphism_010_SinkGadget (String tainted, SinkGadget sinkGadget) {
