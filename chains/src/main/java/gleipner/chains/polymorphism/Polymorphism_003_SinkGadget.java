...
public class Polymorphism_003_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_003_SinkGadget () {
    }

    public Polymorphism_003_SinkGadget (String tainted, SinkGadget sinkGadget) {
