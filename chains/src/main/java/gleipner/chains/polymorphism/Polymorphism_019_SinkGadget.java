...
public class Polymorphism_019_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_019_SinkGadget () {
    }

    public Polymorphism_019_SinkGadget (String tainted, SinkGadget sinkGadget) {
