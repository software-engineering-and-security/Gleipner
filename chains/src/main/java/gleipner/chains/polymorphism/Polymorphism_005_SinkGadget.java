...
public class Polymorphism_005_SinkGadget implements Serializable {

    public String tainted;
    public SinkGadget sinkGadget;

    public Polymorphism_005_SinkGadget () {
    }

    public Polymorphism_005_SinkGadget (String tainted, SinkGadget sinkGadget) {
